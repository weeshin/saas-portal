  ...
  <div class="min-h-screen bg-[#f3f5f1] text-ink">
    ...
    <main class="mx-auto max-w-[1500px] px-5 py-9 sm:px-8 sm:py-12">
      ...
      <section class="mt-5 grid gap-5 md:grid-cols-3">
        ...
        <article class="rounded-[1.5rem] border border-ink/8 bg-white p-6"><div class="flex items-start justify-between"><div><p class="text-xs font-black uppercase tracking-[.16em] text-ink/40">Application</p><p class="mt-3 text-2xl font-black">Inventory</p></div><span class="grid h-10 w-10 place-items-center rounded-xl bg-mint text-leaf">◇</span></div><p class="mt-5 text-sm text-ink/45">Stable release channel · MySQL</p></article>
      </section>
